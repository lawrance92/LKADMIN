...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:14:26 GMT -->
<head>
		<meta charset="UTF-8" />
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										...
										<div class="alert alert-info alert-dismissable">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Welcome to Philbert Dashboard. 
										</div>
							...
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										...
										<div class="alert alert-info alert-dismissable">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
											<i class="zmdi zmdi-info-outline pr-15 pull-left"></i><p class="pull-left">Welcome to Philbert Dashboard.</p> 
											<div class="clearfix"></div>
										</div>
										<div class="alert alert-warning alert-dismissable">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										...
										<div class="alert alert-info alert-dismissable alert-style-1">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
											<i class="zmdi zmdi-info-outline"></i>Welcome to Philbert Dashboard. 
										</div>
