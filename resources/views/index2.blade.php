...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:13:35 GMT -->
<head>
    <meta charset="UTF-8" />
						...
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="panel panel-default card-view">
									...
									<div class="panel-wrapper collapse in">
										<div class="panel-body">
											<div class="flot-container" style="height:189px">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default card-view">
									...
									<div class="panel-wrapper collapse in">
										<div class="panel-body">
											<canvas id="chart_3" height="385"></canvas>
										</div>	
									</div>
								</div>
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-sm-7 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh relative">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div id="ct_chart_5" class="ct-chart ct-perfect-fourth ct-chart-before-pad-zero" style="height:334px;"></div>
					...
					<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh relative">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div>
										<div id="morris_area_chart" class="morris-chart" style="height:334px;"></div>
									</div>
									<div class="label-chatrs">
										<div class="inline-block mr-15">
											<span class="clabels inline-block bg-blue mr-5"></span>
										...
										<div class="inline-block">
											<span class="clabels inline-block bg-yellow mr-5"></span>
											<span class="clabels-text font-12 inline-block txt-dark capitalize-font">high school</span>
										</div>										
									</div>
								</div>
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div id="ct_chart_7" class="ct-chart ct-perfect-fourth ct-chart-before-pad-zero" style="height:260px;"></div>
...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:13:40 GMT -->
</html>
