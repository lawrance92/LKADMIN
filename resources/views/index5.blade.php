...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:13:41 GMT -->
<head>
    <meta charset="UTF-8" />
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-wrapper collapse in">
								<div id="morris_extra_line_chart" class="morris-chart"style="height:370px;"></div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div id="ct_chart_1" class="ct-chart ct-perfect-fourth ct-chart-before-pad-zero" style="height: 345px;"></div>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div id="ct_chart_5" class="ct-chart ct-perfect-fourth ct-chart-before-pad-zero" style="height: 345px;"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div>
										<canvas id="chart_7" height="342"></canvas>
									</div>	
								</div>	
							</div>
						</div>
