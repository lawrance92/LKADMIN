...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/weather.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:13:26 GMT -->
<head>
    <meta charset="UTF-8" />
                ...
                <div class="row">
						...
						<div id="weather_1" class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<div class="dropdown inline-block">
										<button aria-expanded="false" data-toggle="dropdown" class="btn btn-default btn-outline dropdown-toggle border-none pa-0 font-16" type="button"><span>Canada</span><i class="zmdi  zmdi-chevron-down ml-15"></i></button>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<h6 class="block nowday">Tuesday</h6>
									<span class="block nowdate">03/05/2019</span>
									<div class="weather weatherapp mt-15">
										<span class="block temprature pull-left">12<span class="unit">°C</span></span><span class="block temprature-icon pull-left"><img src="https://hencework.com/theme/philbert/img/weathericons/15.svg"></span>
										<div class="clearfix"></div>
										<span class="block currently">3/5, 1:06 PM</span>
										<ul class="other-details">
											<li><span class="spec-label">wind</span> <span class="wind-speed">11 km/h</span><span class="spec-label">humidity</span><span class="humidity">30%</span></li>
											<li><span class="spec-label">sunrise</span><span class="sunrise">5 AM</span><span class="spec-label">high</span><span class="hightem">21°</span></li>
										</ul>
										<ul class="forcast-days">
											<li><span class="forcast-day block">Sun</span><img class="block" src="https://hencework.com/theme/philbert/img/weathericons/7.svg"><span class="forcast-high-deg block">10°C</span></li>
											<li><span class="forcast-day block">Mon</span><img class="block" src="https://hencework.com/theme/philbert/img/weathericons/10.svg"><span class="forcast-high-deg block">10°C</span></li>
											<li><span class="forcast-day block">Tue</span><img class="block" src="https://hencework.com/theme/philbert/img/weathericons/15.svg"><span class="forcast-high-deg block">15°C</span></li>
											<li><span class="forcast-day block">Wed</span><img class="block" src="https://hencework.com/theme/philbert/img/weathericons/20.svg"><span class="forcast-high-deg block">12°C</span></li>
											<li><span class="forcast-day block">Thu</span><img class="block" src="https://hencework.com/theme/philbert/img/weathericons/25.svg"><span class="forcast-high-deg block">18°C</span></li>
											<li><span class="forcast-day block">Fri</span><img class="block" src="https://hencework.com/theme/philbert/img/weathericons/23.svg"><span class="forcast-high-deg block">19°C</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-7 col-xs-12">
						<div class="row">
											...
											<div class="row ma-0">
												<div class="col-xs-6 pa-0">
													<div class="left-block-wrap pa-30">
														...
														<span class="block nowdate">03/05/2019</span>
														<div class="left-block  mt-15"><span class="block temprature ">15<span class="unit">°C</span></span></div>
													</div>
												</div>
												<div class="col-xs-6 pa-0">
													<div class="right-block-wrap pa-30">
														<div class="right-block"><span class="block temprature-icon "><img src="https://hencework.com/theme/philbert/img/weathericons/3.svg"></span><h6>Sydney</h6></div>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default card-view pa-0 weather-warning">
									<div class="panel-wrapper collapse in">
										<div class="panel-body pa-0">
											<div class="row ma-0">
												<div class="col-xs-6 pa-0">
													<div class="left-block-wrap pa-30">
														<p class="block nowday">Tuesday</p>
														<span class="block nowdate">03/05/2019</span>
														<div class="left-block  mt-15"><span class="block temprature ">28<span class="unit">°C</span></span></div>
													</div>
												</div>
												<div class="col-xs-6 pa-0">
													<div class="right-block-wrap pa-30">
														<div class="right-block"><span class="block temprature-icon "><img src="https://hencework.com/theme/philbert/img/weathericons/28.svg"></span><h6>Melbourne</h6></div>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default card-view pa-0 weather-danger">
									<div class="panel-wrapper collapse in">
										<div class="panel-body pa-0">
											<div class="row ma-0">
												<div class="col-xs-6 pa-0">
													<div class="left-block-wrap pa-30">
														<p class="block nowday">Tuesday</p>
														<span class="block nowdate">03/05/2019</span>
														<div class="left-block  mt-15"><span class="block temprature ">25<span class="unit">°C</span></span></div>
													</div>
												</div>
												<div class="col-xs-6 pa-0">
													<div class="right-block-wrap pa-30">
														<div class="right-block"><span class="block temprature-icon "><img src="https://hencework.com/theme/philbert/img/weathericons/20.svg"></span><h6>Newyork</h6></div>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="row ma-0">
												<div class="col-xs-6 pa-0">
													<div class="left-block-wrap pa-30">
														<p class="block nowday">Tuesday</p>
														<span class="block nowdate">03/05/2019</span>
														<div class="left-block  mt-15"><span class="block temprature ">30<span class="unit">°C</span></span></div>
													</div>
												</div>
												<div class="col-xs-6 pa-0">
													<div class="right-block-wrap pa-30">
														<div class="right-block"><span class="block temprature-icon "><img src="https://hencework.com/theme/philbert/img/weathericons/5.svg"></span><h6>Captown</h6></div>
													</div>
												</div>
											</div>
										</div>
...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/weather.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:13:27 GMT -->
</html>
