...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/sweetalert.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:14:24 GMT -->
<head>
		<meta charset="UTF-8" />
					...
					<div class="row">
							...
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										<img src="../img/sweetalert/alert.png" alt="alert" class="img-responsive model_img" id="sa-basic"> 
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-xs-12">
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										<img src="../img/sweetalert/alert2.png" alt="alert" class="img-responsive model_img" id="sa-title"> 
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-md-6 col-xs-12">
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										<img src="../img/sweetalert/alert4.png" alt="alert" class="img-responsive model_img" id="sa-warning"> 
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-xs-12">
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										<img src="../img/sweetalert/alert5.png" alt="alert" class="img-responsive model_img" id="sa-params">
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-xs-12">
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										<img src="../img/sweetalert/alert7.png" alt="alert" class="img-responsive model_img" id="sa-image"> 
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-xs-12">
							<div class="panel panel-default card-view">
								...
								<div  class="panel-wrapper collapse in">
									<div  class="panel-body">
										<img src="../img/sweetalert/alert6.png" alt="alert" class="img-responsive model_img" id="sa-close"> 
									</div>
								</div>
							</div>
						</div>
...
<!-- Mirrored from hencework.com/theme/philbert/full-width-light/sweetalert.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2020 15:14:26 GMT -->
</html>